    ...
    <div class="main">
        ...
        <div  class="wrap">
            <div class="Regisration">
                ...
                <form>
                    <input type="text" value="Username" Lengkap" onfocus="this.value = '';" onblur="if (this.value == '') {
                                    this.value = 'Username';
                                }" >
                    <input type="text" value="Name" Lengkap" onfocus="this.value = '';" onblur="if (this.value == '') {
                                    this.value = 'Name';
                                }" >
