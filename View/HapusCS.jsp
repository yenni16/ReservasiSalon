...
<html>
                ...
                <div class="top-menu">
                    <nav>
                        <ul class="cl-effect-16">
                            ...
                            <li><a href="TambahCS.jsp" data-hover="Tambah Customer Service">Tambah Customer Service</a></li>
    ...
    <div class="main">
        <div class="login-head">
            <h1>Hapus Customer Service</h1>
        </div>
        <div  class="wrap">
            <div class="Regisration">
                <div class="Regisration-head">
                    <h2><span></span>Customer Service</h2>
                </div>
                <form action="./HapusCS">
                    <input type="text" name="uname" value="User Name" onfocus="this.value = '';" onblur="if (this.value == '') {
