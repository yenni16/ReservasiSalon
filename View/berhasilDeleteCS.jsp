<%-- 
    Document   : berhasilDeleteCS
    Created on : May 17, 2016, 10:15:48 PM
    ...
    <body>
                ...
                <div class="top-menu">
                    <nav>
                        <ul class="cl-effect-16">
                            ...
                            <li><a href="DataCustomerService.jsp" data-hover="Daftar CS">Daftar CS</a></li>


                            <li><a href="TambahCS.jsp" data-hover="Tambah CS">Tambah CS</a></li>
                            <li><a  class="active" href="HapusCS.jsp" data-hover="Hapus Customer Service">Hapus Customer Service</a></li>
        ...
        <div>
            <center>               
                <br>
                <br>
                <h1 style = "color: black;">Data berhasil dihapus.</h1>
                <br>
                <a href= "HapusCS.jsp">kembali</a>
            </center></div>
        <!--end-banner-->
    </body>
</html>