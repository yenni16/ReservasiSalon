<%-- 
    Document   : DataPemesanan
    Created on : Apr 3, 2016, 5:33:31 PM
    Author     : User
--%>
...
<html>
    ...
    <body>
        ...
        <div class="products">
            <div class="container">
                <h3 class="tittle">Data Pesanan</h3>
                <div class="tip-main">
...
String query="select * from DATAPESANAN";
            ...
            %>
            <tr>
                <td align="center"><%=res.getString("tanggalTreatment")%> </td>
                <td align="center"><%=res.getString("jam_treatment")%></td>
                <td align="center"><%=res.getString("usernameM")%></td>
                <td align="center"><%=res.getString("status")%></td>
                 </tr>
            <% }%>
</table>
